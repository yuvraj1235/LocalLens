...
import type { SanitizedContext, LogEntry } from "../agentLoop";

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

function makeContext(): SanitizedContext {
  return {
...
): { loop: AgentLoop; logs: LogEntry[]; mockSend: ReturnType<typeof vi.fn> } {
  const logs: LogEntry[] = [];
