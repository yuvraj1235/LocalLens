 ...
 */
export function createChangeDetectorState() {
 ...
 */
export function cheapImageHash(image, gridSize = 8) {
 ...
 */
export function shouldRunFullPipeline(image, domMutationCount, state) {
