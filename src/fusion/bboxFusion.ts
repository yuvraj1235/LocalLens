...
import type { BBox } from "../schema/uiGraph.js";
...
export function toDocumentSpace(bbox: BBox, ctx: ScrollContext): BBox {
  const [x, y, w, h] = bbox;
 ...
 */
export function deduplicateBoxes<T>(boxes: Box<T>[], iouThreshold = 0.5): Box<T>[] {
